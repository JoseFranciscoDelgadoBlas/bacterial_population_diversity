#############################################################
## Resistance Gene Diversity Calculations per Bacterial ST ##
#############################################################
...
# Presence/absence resistance gene data from ARIBA pipeline using ResFinder database
amrMatrix <- fread("~/resistance_gene_content.csv")

# File with samples Ids and origin tag for each sample (WWTP/river)
mapping <-  fread("~/Mapping.csv")

## Calculate jaccard similarity matrix
dist.jac <- vegdist(amrMatrix, method="jaccard", header=FALSE, binary=TRUE, diag=FALSE, upper=FALSE, lower=TRUE)
