######################################################
## Function Diversity Calculations per Bacterial ST ##
######################################################
...
# Presence/absence bacterial function data from anvi'o pipeline using the microbial pangenomics workflow
functionMatrix <- fread("~/function_content.csv")

# File with samples Ids and origin tag for each sample (WWTP/river)
mapping <-  fread("~/Mapping.csv")

## Calculate jaccard similarity matrix
dist.jac <- vegdist(functionMatrix, method="jaccard", header=FALSE, binary=TRUE, diag=FALSE, upper=FALSE, lower=TRUE)
